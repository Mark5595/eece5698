...
public final class imu_packet_t implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x04a65e82afb57bc7L;
    ...
    {
        if (classes.contains(my_types.imu_packet_t.class))
            return 0L;
 
        classes.add(my_types.imu_packet_t.class);
    ...
    public imu_packet_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public imu_packet_t(DataInput ins) throws IOException
    {
    ...
    public static my_types.imu_packet_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        my_types.imu_packet_t o = new my_types.imu_packet_t();
    ...
    public my_types.imu_packet_t copy()
    {
        my_types.imu_packet_t outobj = new my_types.imu_packet_t();
