...
class gps_packet_t(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qddddd", self.timestamp, self.lat, self.lon, self.alt, self.utm_x, self.utm_y))
    ...
    def _decode_one(buf):
        self = gps_packet_t()
        self.timestamp, self.lat, self.lon, self.alt, self.utm_x, self.utm_y = struct.unpack(">qddddd", buf.read(48))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x87343694a4b24f74) & 0xffffffffffffffff
